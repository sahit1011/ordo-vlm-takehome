...
**Per-precision table (Qwen2.5-VL-3B family, Mac reference; phone champion cells alongside):**

| Precision | Size | Accuracy (n=24) | GPU prefill | GPU decode | Peak RAM* | Encode |
|---|---|---|---|---|---|---|
